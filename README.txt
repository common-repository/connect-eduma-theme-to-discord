...
Tags: Discord, Eduma themme, Memberships, discord role management, lms, learnpress, learning community management, learnpress discord addon
...
== Description ==
This add-on enables connecting your Eduma Theme website to your discord server. With this plugin, you can create a discord community of your students and assign them discord roles in your server according to the course they are learning.
...
Connect Eduma Theme to Discord Plugin Features:
...
1. Go to Plugins > Add New to find and install connect Eduma theme to discord.
...
10. [Connect BadgeOS to Discord](https://wordpress.org/plugins/connect-badgeos-to-discord/)
11. [Connect LearnPress and Discord](https://wordpress.org/plugins/connect-learnpress-discord-add-on/)
12. [Connect ProfilePress and Discord](https://wordpress.org/plugins/connect-profilepress-and-discord/)
13. [Connect Restrict Content Pro and Discord](https://wordpress.org/plugins/connect-restrictcontentpro-to-discord-addon/)
...
== Screenshots ==
1. Install and activate the plugin and view the "Discord Settings" menu inside Eduma.
2. Map Discord roles and LearnPress courses.
3. Map Discord roles and PMPRO Membership Levels.
4. Advanced settings.
5. Connect Button Appearance.
6. Spot the "Connect to Discord" LearnPress profile.
7. Spot the "Connect to Discord" WooCommerce account.